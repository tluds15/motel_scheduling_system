...
function show_home(){
    ...
    <p><img height="${window.innerHeight}" src="images/motel_logo.jpeg"></p>
...
async function show_rooms(){
    ...
    if (response.status==='success'){
        ...
        for(const record of response.records){
            ...
            //html.push(`<td><a href="${record.fields.url}" target="_blank">Click to see room</a></td>`)
            html.push(`<td><link src="${record.fields.url}" target="_blank"></td>`)
            html.push('</tr>')
        }
...
async function show_locations(){
    ...
    tag("canvas").innerHTML=`<div class="center-screen"><iframe class="airtable-embed" src="https://airtable.com/embed/appJDml9zVsgUAuKl/shrUMHJDdyVAwkHzO?backgroundColor=blue&viewControls=on" frameborder="0" onmousewheel="" width="100%" height="533" style="background: transparent; border: 1px solid #ccc;"></iframe></div>`
    hide_menu()
}
...
async function record_inventory(params){
    ...
    if(!params){
        ...
        tag("canvas").innerHTML=` 
            <div class="page">
                <div id="inventory-title" style="text-align:center"><h2>Select Rooms</h2></div>
...
async function show_inventory_summary(params){
    ...
    tag("canvas").innerHTML=` 
        <div class="page">
            <div id="inventory-title" style="text-align:center"><h2>Reservations</h2></div>
            <div id="inventory-message" style="width:100%"></div>
            <div id="inventory_panel"  style="width:100%">
            </div>
        </div>  
